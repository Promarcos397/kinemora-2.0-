  ...
  return (
    <div className="pt-24 px-6 md:px-14 lg:px-20 pb-12 min-h-screen">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <h2 className="text-2xl md:text-3xl font-bold text-white">My List</h2>
      ...
      {myList.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center mt-32 text-gray-500 animate-fadeIn">
          <div className="w-20 h-20 rounded-full bg-[#222] flex items-center justify-center mb-6 border border-white/5">
             <span className="material-icons text-4xl text-gray-600">playlist_add</span>
          </div>
          <p className="text-xl font-medium text-gray-300">Your list is empty</p>
          <p className="text-sm mt-2 max-w-md text-center">Titles you add to your list will appear here. Add movies and TV shows to keep track of what you want to watch.</p>
        </div>
      )}
    </div>
  );
