        ...
        >
          {initialLoad 
            ? Array.from({ length: 12 }).map((_, i) => (
                <div key={i} className="relative flex-none w-[180px] h-[101px] md:w-[240px] md:h-[135px] bg-[#222] rounded-md overflow-hidden border border-white/5 pointer-events-auto">
