    ...
    return (
        ...
        >
            <div className="mt-16 sm:mt-0 max-w-[90%] sm:max-w-lg md:max-w-2xl lg:max-w-3xl space-y-4 md:space-y-6 pointer-events-auto">
                ...
                <p className={`text-sm md:text-base text-gray-100 line-clamp-3 drop-shadow-md font-normal leading-relaxed text-shadow-sm max-w-lg transition-opacity duration-700 ${isVideoReady && !hasVideoEnded ? 'opacity-0' : 'opacity-100'}`}>
                    {movie?.overview}
                </p>
