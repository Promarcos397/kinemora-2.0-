...
const SettingsLayout: React.FC<SettingsLayoutProps> = ({ settings, updateSettings, continueWatching, onReset }) => {
    ...
    const renderDetail = () => {
        switch (currentView) {
            ...
            case 'language':
                return <DetailWrapper title="Languages" onBack={handleBack}><PlaceholderSection title="Language Preferences" message="Multi-language display settings are coming soon." icon={<TranslateIcon size={32} />} /></DetailWrapper>;
