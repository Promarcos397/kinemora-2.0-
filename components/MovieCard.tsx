...
const MovieCard: React.FC<MovieCardProps> = ({ movie, onSelect, isGrid = false }) => {
  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <div className={`absolute top-[-35px] md:top-[-45px] z-[100] ${posClasses.wrapper}`}>
          <div
            className={`w-[240px] md:w-[260px] bg-[#141414] rounded-md shadow-[0_14px_36px_rgba(0,0,0,0.75),0_8px_16px_rgba(0,0,0,0.6)] animate-scaleIn ring-1 ring-zinc-700/50 ${posClasses.inner}`}
